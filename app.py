...
<div style='text-align: center; padding: 2rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 15px; margin-top: 3rem;'>
    <h3 style='color: white; margin: 0 0 1rem 0; font-size: 1.5rem;'>🔮 ALADDIN Oracle System</h3>
    <p style='color: white; font-size: 1rem; margin: 0.5rem 0; opacity: 0.9;'>
        Advanced AI • News Intelligence • Historical Patterns • Behavioral Analysis
    </p>
    <p style='color: white; font-size: 0.9rem; margin: 1rem 0 0 0; opacity: 0.8;'>
        ⚠️ <strong>Disclaimer:</strong> This system provides analytical insights based on AI and statistical models.<br>
        Not financial advice. Trading involves significant risk. Consult professionals before investing.<br>
        Never invest more than you can afford to lose.
    </p>
    <p style='color: white; font-size: 0.8rem; margin: 0.5rem 0 0 0; opacity: 0.7;'>
        Last Update: {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S UTC')}<br>
        © 2025 ALADDIN AI • All Rights Reserved
    </p>
</div>
