...
def advanced_predict_price(df_ind, steps=30):
    try:
        ...
        return predict_price(df_ind, steps=5)  # Fallback
...
if session_key in st.session_state:
    ...
    if symbol == 'GC=F':
        ...
        # Display as in original, use gold_analysis['target_1y'] etc.
    ...
    # Resto del codice: suggestions, analysis, etc. as in original

# Expander and footer as in original
